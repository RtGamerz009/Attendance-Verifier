    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-background">
      ...
      <div className="z-10 text-center px-4 max-w-3xl mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 w-full max-w-4xl animate-in fade-in zoom-in-95 duration-700 delay-300">
          ...
          <Link href="/register">
            <a className="group relative p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-white/10 hover:border-primary/50 transition-all flex flex-col items-center text-center gap-4 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] hover:-translate-y-1">
          ...
          <Link href="/attendance">
            <a className="group relative p-6 rounded-2xl bg-primary/5 backdrop-blur-sm border border-primary/30 hover:border-primary transition-all flex flex-col items-center text-center gap-4 hover:shadow-[0_0_40px_rgba(6,182,212,0.25)] hover:-translate-y-1">
          ...
          {/* Admin Dashboard */}
          <Link href="/admin">
            <a className="group relative p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-white/10 hover:border-accent/50 transition-all flex flex-col items-center text-center gap-4 hover:shadow-[0_0_30px_rgba(255,255,255,0.05)] hover:-translate-y-1">
